...
uses
  ...
  MemDS, frxClass, Datasnap.DBClient, Datasnap.Provider;
type
  TDM = class(TDataModule)
    ...
    T_tempfacturation: TUniTable;
    UniDataSource2: TUniDataSource;
    T_temptravaux: TUniTable;
    T_temptravauxidtravaux: TIntegerField;
    T_temptravauxdesignation: TStringField;
    UniDataSource3: TUniDataSource;
    T_temptravauxnumfacture: TStringField;
    Q_CLIENTDS: TUniDataSource;
    Q_client: TUniQuery;
    Q_societe: TUniQuery;
    Q_SOCIETEDS: TUniDataSource;
    T_tempvoiture: TUniTable;
    T_TEMPVOITUREDS: TUniDataSource;
    T_client: TUniTable;
